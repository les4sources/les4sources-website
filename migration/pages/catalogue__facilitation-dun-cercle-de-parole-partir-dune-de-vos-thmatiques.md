---
title: "Cercle de parole à partir d’une de vos thématiques"
description: "Expérimentez un espace participatif et inclusif de qualité offrant à chacun.e la possibilité de s’exprimer."
path: /catalogue/facilitation-dun-cercle-de-parole-partir-dune-de-vos-thmatiques
ogImage: "https://images.unsplash.com/photo-1582213782179-e0d53f98f2ca?ixlib=rb-4.0.3&cs=srgb"
cover: images/_shared/e39d7b5318ca-photo-1582213782179-e0d53f98f2ca.jpg
properties:
  Statut: Indisponible
...
#### Expérimentez un espace participatif et inclusif de qualité offrant à chacun.e la possibilité de s’exprimer.

Cet atelier vous propose d'explorer une thématique de votre choix à travers une approche participative et inclusive. Il propose un cadre bienveillant et respectueux pour exprimer, écouter, comprendre et s’enrichir de différents points de vue ou partages de vécus. Il peut permettre à des amis, des collectifs et des associations de questionner comment chacun.e se sent dans ce groupe, offre la possibilité de partager des expériences personnelles à partir d’une thématique choisie ou d’entendre le ressenti de chacun.e concernant une proposition apportée ou situation vécue.

Cette pratique spécifique amène un espace de qualité, d’écoute et d’attention dans lequel chacun.e est amené à s’impliquer. Elle apporte un espace d’écoute collective sortant de la logique de discussion et de débat. C'est une opportunité précieuse pour renforcer la cohésion de votre groupe et favoriser une culture de dialogue ouvert et constructif.
...
|  |  |  |
| --- | --- | --- |
| ***Cercle de parole à partir d'une de vos thématiques*** | ***4 à 7 pers.*** | ***8 à 15 pers.*** |
| 1h00 | 60€ | / |
...
- [Participation à la production du pain](/catalogue/participation-la-production-du-pain) — Production et transformation
