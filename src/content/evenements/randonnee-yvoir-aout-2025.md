...
properties:
  ...
  Thématique: "Sports, Ressourcement, Environnement"
  Date (fr): "du 9 au 11 août 2025"
  Places disponibles: "12"
  Statut site web: "Publié"
category: "Sports, Ressourcement, Environnement"
---
...
Nous découvrirons le château et le cimetière de Crupet avant de passer par une ancienne carrière pour enfin longer le Bocq.

- **Jour 3 (11 août) : balade des 7 Meuses**
...
- **Hébergement** : bivouac dans les bois (avec proposition de dormir dans un hamac)
- **Nourriture** : la nourriture est comprise. Le repas du soir sera agrémenté de plantes sauvages et réalisé par la cuisinière des 4 Sources
- **Ticket de train (de Yvoir à Dinant pour jour 1)** : compris dans le prix
- **Tarif** : **1 jour** : 5€ (transport et matériel) + 6€ pour le souper (optionnel) **2 jours** : 40€ (hébergement, nourriture, train, matériel compris) + 6€ pour le souper du jour 2 (optionnel) **3 jours** : 65€ TOUT compris
...
**[Formulaire d’inscription](https://docs.google.com/forms/d/e/1FAIpQLSecw9yvCX2lp9bPj45pd0Z3rCelcaagVl2O7H89-j4PPYgEwg/viewform?usp=dialog)** **(attention : c’est complet !)**

*Les informations pour le paiement seront fournies par la suite via Colin*
