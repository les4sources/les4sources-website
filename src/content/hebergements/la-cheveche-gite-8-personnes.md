---
title: "La Chevêche"
description: "Au coeur d’un écolieu dans une clairière entourée de forêts. Logement de caractère. Randonnées, VTT. Proche d’Yvoir et de Crupet."
...
#### Un logement de caractère unique, situé au coeur d'un écolieu où vivent 6 familles.
...
La Chevêche se situe dans une grande bâtisse composée de 2 hébergements indépendants, partageant le même couloir d'entrée. Le reste du bâtiment accueille une habitante, nos salles disponibles à la location et la cuisine professionnelle.

Cet hébergement pour 8 personnes se situe au rez-de-chaussée.
...
→ Taques au gaz, four et frigo (il n’y a pas de lave-vaisselle)

→ Percolateur et bouilloire

→ Grille-pain

### La chambre “Balsamine”

→ 2 lits simples pouvant être réunis en un lit double + 1 lit superposé

→ Une salle de douche avec douche, WC et évier
...
Notre carte de balades, disponible dans la Chevêche, permet de partir majoritairement des 4 Sources et de découvrir les forêts et paysages de la vallée du Bocq.
