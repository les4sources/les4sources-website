---
title: "Coworking dans la Clairière"
description: "Tu cherches un lieu au calme, avec une nature environnante exceptionnelle pour mieux te concentrer ? Viens coworker aux 4 sources !"
legacyPath: "/coworking"
cover: "../../assets/migration/coworking/01-_G0A4642.jpg"
coverAlt: "Coworking dans la Clairière"
icon: "💼"
---

#### Tu cherches un lieu au calme, avec une nature environnante exceptionnelle pour mieux te concentrer ? Viens coworker aux 4 sources !
...
![G0A4644](../../assets/migration/coworking/02-_G0A4644.jpg)

### Services inclus

Mise à disposition d’un bureau avec câble Ethernet, écran, clavier et souris (pas de tour/ordinateur), ainsi qu’une imprimante-scanner. 📇 **Imprimante :** son utilisation se fait de manière eco-responsable. Une petite caisse est disponible au bar en auto-gestion, afin de payer les impressions effectuées. Voir les tarifs ci-dessous. 📶 **Internet :** via un câble Ethernet ou simplement par le Wifi disponible. 🚗 **Parking** : un parking gratuit est à disposition devant le bâtiment. 🥪 **Repas et pause** : tu pourras manger ton sandwich ou ta salade sur la terrasse en t’assurant de la laisser propre ensuite. Tasses, verres, couverts… sont disponibles dans la cuisine professionnelle. Merci de les nettoyer et les ranger après utilisation ! 🧋 **Les consommables** (thé, café, tisanes, sucre, etc) sont mis à disposition au bar ; ils sont à consommer sur place et de façon raisonnable.

![G0A2834](../../assets/migration/coworking/03-_G0A2834.jpg)
...
![G0A4642](../../assets/migration/coworking/04-_G0A4642.jpg)
...
![G0A4640](../../assets/migration/coworking/05-_G0A4640.jpg)
